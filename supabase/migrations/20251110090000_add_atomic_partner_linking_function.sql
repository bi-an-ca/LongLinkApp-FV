/*
  # Atomic Partner Linking Function
  
  Creates a database function to atomically link two partners, preventing race conditions
  and ensuring data consistency.
*/

-- Create function to atomically link partners
