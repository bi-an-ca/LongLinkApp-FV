/*
  ...
  Track important relationship milestones like anniversaries, first message, etc.
*/
...
CREATE TABLE IF NOT EXISTS relationship_milestones (
  ...
  milestone_type text NOT NULL, -- 'anniversary', 'first_message', 'first_memory', 'custom'
  title text NOT NULL,
  description text,
